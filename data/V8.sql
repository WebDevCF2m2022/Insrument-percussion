...
CREATE TABLE IF NOT EXISTS `musiciens` (
  ...
  `prenom_musicien` varchar(255) DEFAULT NULL,
...
(2, 'DaftPunk', '', 'https://fr.wikipedia.org/wiki/Daft_Punk'),
...
INSERT INTO `users` (`idusers`, `login`, `motdepasse`, `identite`, `lemail`, `uniqueID`) VALUES
(1, 'test', '$2y$10$P6PmhQsmGyuqV/k/2UX0BeTtAiUY4Vex/7LSRQJ4me0m8RBweTtOa', 'test', 'test@lemail.test', '1');
...
--
ALTER TABLE `image`
  ADD CONSTRAINT `fk_image_instruments1` FOREIGN KEY (`instruments_id`) REFERENCES `instruments` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
